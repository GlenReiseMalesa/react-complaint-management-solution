       ...
       <div className="myComplaints">
            ...
            <div className="container mt-5">
                ...
                <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="#" className="nav-link px-2 link-dark">Your Maintanance Issues</a></li>
                </ul>
                </header>
            </div>  
                            ...
                            return (
                                <div className="w-75 m-auto card text-center mb-5">
                                    <div className="card-body">
                                        ...
                                        <a className="btn btn-secondary">pending</a>
                                    </div>
                        ...
                        if(complaint.status == "started"){
                            return (
                                <div className="w-75 m-auto card text-center mb-5">
                                    <div className="card-body">
                                        <p className="card-text">{complaint.description}</p>
                                        <a className="btn btn-warning">started</a>
                                    </div>
                                    <div className="card-footer text-muted">
                                    posted {days(date_1, date_2)}  days ago and is being handled by {complaint.emailHandledBy} .
                                    </div>
                                </div>
                            );
                        }
                        ...
                        if(complaint.status == "completed"){
                            return (
                                <div className="w-75 m-auto card text-center mb-5">
                                    ...
                                    <div className="card-footer text-muted">
                                    posted {days(date_1, date_2)}  days ago and was handled by {complaint.emailHandledBy} .
                                    </div>
                                </div>
                            );
                        }
